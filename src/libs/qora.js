...
export function generateAccountSeed (seed, nonce, returnBase58) {
  ...
  var nonceBytes = int32ToBytes(nonce)
...
function generatePaymentTransaction (keyPair, lastReference, recipient, amount, fee, timestamp, signature) {
  return appendBuffer(generatePaymentTransactionBase(keyPair.publicKey, lastReference, recipient, amount, fee, timestamp), signature)
}
...
export default {
  generateAccountSeed: generateAccountSeed,
  getKeyPairFromSeed: getKeyPairFromSeed,
  getAccountAddressFromPublicKey: getAccountAddressFromPublicKey,
  isValidAddress: isValidAddress,
  generateSignaturePaymentTransaction: generateSignaturePaymentTransaction,
  generatePaymentTransaction: generatePaymentTransaction,
  generateSignatureArbitraryTransactionV3: generateSignatureArbitraryTransactionV3,
  generateArbitraryTransactionV3: generateArbitraryTransactionV3,
  generateSignatureRegisterNameTransaction: generateSignatureRegisterNameTransaction,
  generateRegisterNameTransaction: generateRegisterNameTransaction
}
